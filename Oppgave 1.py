...
def find_lowest_sum(matrix):
    rows = len(matrix)
    cols = len(matrix[0])

    #Hjelpematrise for å lagre de laveste sumverdiene
    dp = [[0] * cols for _ in range(rows)]

    #Fyll opp første rad og kolonne med sumverdiene
    dp[0][0] = matrix[0][0]
    ...
    #Beregn de laveste sumverdiene ved å velge den minste av summen
    for i in range(1, rows):
        for j in range(1, cols):
            dp[i][j] = min(dp[i - 1][j], dp[i][j - 1]) + matrix[i][j]

    #Rekonstruer veien med lavest sum ved å følge de valgene som gir den minste summen
    path = []
    i, j = rows - 1, cols - 1
    while i > 0 or j > 0:
    ...
    return dp[rows - 1][cols - 1], list(reversed(path))


def find_highest_sum(matrix):
    rows = len(matrix)
    cols = len(matrix[0])

    #Hjelpematrise for å lagre de høyeste sumverdiene
    dp = [[0] * cols for _ in range(rows)]
    ...
    #Beregn de høyeste sumverdiene ved å velge den største av summen
    for i in range(1, rows):
        for j in range(1, cols):
            dp[i][j] = max(dp[i - 1][j], dp[i][j - 1]) + matrix[i][j]

    #Rekonstruer veien med høyest sum ved å følge de valgene som gir den største summen
    path = []
    i, j = rows - 1, cols - 1
    while i > 0 or j > 0:
        path.append(matrix[i][j])
...
print("Array 1")
lowest_sum, lowest_path = find_lowest_sum(array1)
highest_sum, highest_path = find_highest_sum(array1)
print("Lowest Sum:", lowest_sum)
print("Path with Lowest Sum:", lowest_path)
print("Highest Sum:", highest_sum)
print("Path with Highest Sum:", highest_path)

print("Array 2")
lowest_sum, lowest_path = find_lowest_sum(array2)
highest_sum, highest_path = find_highest_sum(array2)
print("Lowest Sum:", lowest_sum)
print("Path with Lowest Sum:", lowest_path)
print("Highest Sum:", highest_sum)
print("Path with Highest Sum:", highest_path)
...
print("Array 3")
lowest_sum, lowest_path = find_lowest_sum(array3)
highest_sum, highest_path = find_highest_sum(array3)
print("Lowest Sum:", lowest_sum)
print("Path with Lowest Sum:", lowest_path)
print("Highest Sum:", highest_sum)
print("Path with Highest Sum:", highest_path)
...
print("Array 4")
lowest_sum, lowest_path = find_lowest_sum(array4)
highest_sum, highest_path = find_highest_sum(array4)
print("Lowest Sum:", lowest_sum)
print("Path with Lowest Sum:", lowest_path)
print("Highest Sum:", highest_sum)
print("Path with Highest Sum:", highest_path)
...
print("Array 6")
lowest_sum, lowest_path = find_lowest_sum(array6)
highest_sum, highest_path = find_highest_sum(array6)
print("Lowest Sum:", lowest_sum)
print("Path with Lowest Sum:", lowest_path)
print("Highest Sum:", highest_sum)
print("Path with Highest Sum:", highest_path)